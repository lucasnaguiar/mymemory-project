...
use App\Http\Requests\Memo\ProcessAudioRequest;
use App\Http\Resources\Memo\MemoResource;
use App\Services\Memo\AudioMemoService;
use Illuminate\Http\JsonResponse;

class AudioMemoController extends Controller
{
    public function __construct(private readonly AudioMemoService $service) {}

    /** POST /api/v1/memos/audio/process */
    public function process(ProcessAudioRequest $request): JsonResponse
    {
    ...
    /** POST /api/v1/memos/audio/confirm */
